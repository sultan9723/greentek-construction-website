        ...
        <div className="md:hidden px-5 pt-12 pb-6 flex flex-col items-center text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex justify-center gap-4 mt-4">
              ...
              <a href={siteConfig.social.twitter} className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-green-600 transition-colors duration-200">
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.045 4.126H5.078z"/></svg>
              </a>
            </div>
          </div>
